...
def mixnet105(**kwargs):
    model = MixNet(num_init_features=64, k1=32, k2=32, block_config=(6, 12, 20), **kwargs)  #6, 12, 20, 12
    return model
...
class MixNet(nn.Module):
    def __init__(self, block_config=(6, 12, 24, 16), num_init_features=64, expansion=4, k1=32, k2=32, drop_rate=0, num_classes=1000):
        ...
        self.reg_layer = nn.Sequential(
            ...
            nn.Conv2d(num_features, 512, kernel_size=3, padding=1),
...
if __name__ == '__main__':
    net = mixnet105()
    res = net(torch.rand([1,3,512,512]))
