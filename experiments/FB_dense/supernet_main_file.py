...
from supernet_functions.ghost_net import ghost_net
...
def train_supernet():
    ...
    if True:
        ...
        base_weights = torch.load("/home/yabin/imagenet/PL-ImageNet/model_best.pth.tar", map_location=torch.device('cuda'))['state_dict']
