...
CONFIG_SUPERNET = {
    ...
    'dataloading': {
        'dataset_path': "/home/yabin/FasterCrowdCountingNAS/UCF-QNRF_ECCV18", #r"C:\Users\38623\Documents\GitHub\FasterCrowdCountingNAS\UCF-QNRF_ECCV18"
        'crop_size': 512,
        'is_gray': False,
        'num_workers': 8,
        'batch_size': 1,
    ...
    'train_settings' : {
        ...
        'cnt_epochs' : 9999,
        'train_thetas_from_the_epoch' : 50,
        # for Gumbel Softmax
