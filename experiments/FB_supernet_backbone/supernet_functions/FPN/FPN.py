...
from supernet_functions.FPN.FCN_res import resnet50
from supernet_functions.FPN.FCN import VGGNet
...
class FPN(nn.Module):
    ...
    def forward(self, x, t):
        ...
        s2 = self._upsample(self.gn1(self.semantic_branch(p2)), h, w)
        return torch.abs(self.conv3(s2 + s3 + s4 + s5))
